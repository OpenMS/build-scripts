...
then
  ...
  svn export --non-interactive --trust-server-cert  --force https://github.com/jpfeuffer/THIRDPARTY/trunk/All $SEARCH_ENGINES_DIRECTORY > $LOG_PATH/thirdparty_git.log || echo "Cloning of multiplatform Thirdparty binaries went wrong"
  svn export --non-interactive --trust-server-cert --force https://github.com/jpfeuffer/THIRDPARTY/trunk/${OPSYS^}/${ARCH_NO_BIT}bit $SEARCH_ENGINES_DIRECTORY >> $LOG_PATH/thirdparty_git.log || echo "Cloning of Linux Thirdparty binaries went wrong"

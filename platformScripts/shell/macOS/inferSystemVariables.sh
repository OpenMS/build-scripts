...
export CONTRIB_URL="https://abibuilder.informatik.uni-tuebingen.de/archive/openms/contrib/$OPSYS/$SUBDISTRO_VERSION/$TARGET_ARCH/$COMPILER/contrib_build.tar.gz"

...
curl -sSL -O https://github.com/Kitware/CMake/releases/download/v3.25.0/cmake-3.25.0.tar.gz
sudo tar zxf cmake-3.25.0.tar.gz -C /opt/
export PATH="/opt/cmake-3.25.0/bin:$PATH"

...
export CONTRIB_URL="https://abibuilder.informatik.uni-tuebingen.de/archive/openms/contrib/$OPSYS/$DISTRO/$SUBDISTRO_NAME/$SUBDISTRO_VERSION/$TARGET_ARCH/$COMPILER/contrib_build.tar.gz"

...
if(APPLE)
  ...
  CTEST_CONFIGURE(OPTIONS "-DPACKAGE_TYPE=${MY_PACK_TYPE};-DSEARCH_ENGINES_DIRECTORY=$ENV{SEARCH_ENGINES_DIRECTORY};-DCPACK_BUNDLE_APPLE_CERT_APP=$ENV{CPACK_BUNDLE_APPLE_CERT_APP}")
endif()
...
if (APPLE AND DEFINED CMAKE_VERSION AND "${CMAKE_VERSION}" VERSION_LESS "3.5")
  set(PACKAGE_TARGET "final_package")
else()

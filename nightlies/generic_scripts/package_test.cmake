...
if(${CMAKE_SYSTEM_NAME} MATCHES "Darwin") 
	...
	execute_process(
		COMMAND ${CMAKE_COMMAND} -DPACKAGE_TYPE=deb -DLATEX_COMPILER:FILEPATH=/usr/bin/latex -DPDFLATEX_COMPILER:FILEPATH=/usr/bin/pdflatex -DSEARCH_ENGINES_DIRECTORY=${THIRDPARTY_ROOT} ${CTEST_SOURCE_DIRECTORY}
		WORKING_DIRECTORY "${CTEST_BINARY_DIRECTORY}/"
		RESULT_VARIABLE RECONFIGURE_FOR_PACKAGE_BUILD
		OUTPUT_VARIABLE RECONFIGURE_FOR_PACKAGE_BUILD_OUT
		ERROR_VARIABLE RECONFIGURE_FOR_PACKAGE_BUILD_OUT  
